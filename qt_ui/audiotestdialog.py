...
from qt_ui.audiogenerationwidget import AudioGenerationWidget
...
class AudioTestDialog(QDialog, Ui_AudioTestDialog):
    ...
    def preferred_channel_count(self):
        return [self.spinBox_channel_count.value()]

    def channel_mapping(self, channel_count):
        return list(range(self.spinBox_channel_count.value()))
    ...
    def audio_start(self):
        ...
        self.audio_gen.start(api_name, device_name, 'high', self)
