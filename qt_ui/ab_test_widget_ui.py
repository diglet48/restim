...
class Ui_ABTestWidget(object):
    def setupUi(self, ABTestWidget):
        ...
        self.b_pulse_count = QtWidgets.QSpinBox(self.groupBox)
        self.b_pulse_count.setMinimum(1)
        self.b_pulse_count.setMaximum(1000)
        self.b_pulse_count.setProperty("value", 20)
        self.b_pulse_count.setObjectName("b_pulse_count")
        self.gridLayout.addWidget(self.b_pulse_count, 2, 2, 1, 1)
        ...
        self.a_pulse_count = QtWidgets.QSpinBox(self.groupBox)
        self.a_pulse_count.setMinimum(1)
        self.a_pulse_count.setMaximum(1000)
        self.a_pulse_count.setProperty("value", 20)
        self.a_pulse_count.setObjectName("a_pulse_count")
        self.gridLayout.addWidget(self.a_pulse_count, 2, 1, 1, 1)
        ...
        ABTestWidget.setTabOrder(self.b_volume, self.a_pulse_count)
        ABTestWidget.setTabOrder(self.a_pulse_count, self.b_pulse_count)
        ABTestWidget.setTabOrder(self.b_pulse_count, self.a_carrier)
    ...
    def retranslateUi(self, ABTestWidget):
        ...
        self.label_4.setText(_translate("ABTestWidget", "B signal"))
        ...
        self.label_3.setText(_translate("ABTestWidget", "number of pulses"))
        ...
        self.label_2.setText(_translate("ABTestWidget", "A signal"))
