...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        self.tab_foc = QtWidgets.QWidget()
        self.tab_foc.setObjectName("tab_foc")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.tab_foc)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.groupBox_8 = QtWidgets.QGroupBox(self.tab_foc)
        ...
        self.focstim_use_teleplot = QtWidgets.QCheckBox(self.groupBox_8)
        self.focstim_use_teleplot.setText("")
        self.focstim_use_teleplot.setObjectName("focstim_use_teleplot")
        self.gridLayout_5.addWidget(self.focstim_use_teleplot, 1, 2, 1, 1)
        self.refresh_serial_devices = QtWidgets.QToolButton(self.groupBox_8)
        self.refresh_serial_devices.setObjectName("refresh_serial_devices")
        ...
        self.focstim_port = QtWidgets.QComboBox(self.groupBox_8)
        ...
        self.focstim_port.setObjectName("focstim_port")
        self.gridLayout_5.addWidget(self.focstim_port, 0, 2, 1, 1)
        self.focstim_teleplot_prefix = QtWidgets.QLineEdit(self.groupBox_8)
        self.focstim_teleplot_prefix.setObjectName("focstim_teleplot_prefix")
        ...
        self.tab_neostim = QtWidgets.QWidget()
        self.tab_neostim.setObjectName("tab_neostim")
        self.verticalLayout_8 = QtWidgets.QVBoxLayout(self.tab_neostim)
        self.verticalLayout_8.setObjectName("verticalLayout_8")
        self.groupBox_4 = QtWidgets.QGroupBox(self.tab_neostim)
        self.groupBox_4.setObjectName("groupBox_4")
        self.gridLayout_6 = QtWidgets.QGridLayout(self.groupBox_4)
        self.gridLayout_6.setObjectName("gridLayout_6")
        self.neostim_refresh_serial_devices = QtWidgets.QToolButton(self.groupBox_4)
        self.neostim_refresh_serial_devices.setObjectName("neostim_refresh_serial_devices")
        ...
        self.heresphere_latency = QtWidgets.QDoubleSpinBox(self.groupBox_6)
        self.heresphere_latency.setMinimum(0.0)
        self.heresphere_latency.setMaximum(1000.0)
        self.heresphere_latency.setDecimals(0)
        self.heresphere_latency.setObjectName("heresphere_latency")
        self.gridLayout_3.addWidget(self.heresphere_latency, 1, 1, 1, 1)
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.groupBox_8.setTitle(_translate("PreferencesDialog", "FOC-Stim"))
        self.label_16.setText(_translate("PreferencesDialog", "teleplot prefix"))
        self.refresh_serial_devices.setText(_translate("PreferencesDialog", "Refresh"))
        self.label_15.setText(_translate("PreferencesDialog", "Use teleplot"))
        self.label_14.setText(_translate("PreferencesDialog", "Serial port"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_foc), _translate("PreferencesDialog", "FOC-Stim"))
        self.groupBox_4.setTitle(_translate("PreferencesDialog", "NeoStim"))
        self.neostim_refresh_serial_devices.setText(_translate("PreferencesDialog", "Refresh"))
        self.label_17.setText(_translate("PreferencesDialog", "Serial port"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_neostim), _translate("PreferencesDialog", "NeoStim"))
