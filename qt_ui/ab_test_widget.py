...
class ABTestWidget(QtWidgets.QWidget, Ui_ABTestWidget):
    def __init__(self, parent=None):
        ...
        self.axis_a_train_duration = create_constant_axis(settings.ab_test_train_duration.get())
        ...
        self.axis_b_train_duration = create_constant_axis(settings.ab_test_train_duration.get())
        ...
        self.axis_a_train_duration_controller = AxisController(self.a_train_duration)
        self.axis_a_train_duration_controller.link_axis(self.axis_a_train_duration)
        ...
        self.axis_b_train_duration_controller = AxisController(self.b_train_duration)
        self.axis_b_train_duration_controller.link_axis(self.axis_b_train_duration)
        ...
        self.axis_a_train_duration_controller.modified_by_user.connect(self.settings_changed)
        ...
        self.axis_b_train_duration_controller.modified_by_user.connect(self.settings_changed)
