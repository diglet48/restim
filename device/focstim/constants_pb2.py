...
if not _descriptor._USE_C_DESCRIPTORS:
    ...
    _globals['_AXISTYPE']._serialized_end = 556
    _globals['_BOARDIDENTIFIER']._serialized_start = 558
    _globals['_BOARDIDENTIFIER']._serialized_end = 640
    _globals['_OUTPUTMODE']._serialized_start = 642
    _globals['_OUTPUTMODE']._serialized_end = 719
    _globals['_STREAMINGMODE']._serialized_start = 721
    _globals['_STREAMINGMODE']._serialized_end = 805
    _globals['_ERRORS']._serialized_start = 808
    _globals['_ERRORS']._serialized_end = 950